...
% % step 1: read the two image and initialize the K matrix.
...
fx = 1698.873755/im_div_scale; fy = 1698.8796645/im_div_scale;
cx = 971.7497705/im_div_scale; cy = 647.7488275/im_div_scale;
...
% MATLAB 3D visualizer sucks big-time, so better store the 
